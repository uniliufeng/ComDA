...
static char vcid[] = "$Id: canopy_evap.c,v 5.3.2.1 2009/06/09 09:54:10 vicadmin Exp $";
...
double Vic::canopy_evap(layer_data_struct *layer_wet,
...
void Vic::transpiration(layer_data_struct *layer,
		   int veg_class, 
		   int month, 
		   double rad,
		   double vpd,
