...
static char vcid[] = "$Id: calc_atmos_energy_bal.c,v 5.3.2.6 2009/09/20 02:32:07 vicadmin Exp $";

double Vic::calc_atmos_energy_bal(double  InOverSensible,
...
double Vic::solve_atmos_energy_bal(double Tcanopy, ...) {
  ...
  va_start(ap, Tcanopy);
  error = func_atmos_energy_bal(this,Tcanopy, ap);
  va_end(ap);
...
double Vic::error_calc_atmos_energy_bal(double Tcanopy, ...) {
...
double Vic::error_print_atmos_energy_bal(double Tcanopy, va_list ap) {
...
double Vic::solve_atmos_moist_bal(double VPcanopy, ...) {
...
double Vic::error_calc_atmos_moist_bal(double VPcanopy, ...) {
...
double Vic::error_print_atmos_moist_bal(double VPcanopy, va_list ap) {
