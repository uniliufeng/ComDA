...
static char vcid[] = "$Id: snow_melt.c,v 5.7.2.5 2009/10/08 21:30:59 vicadmin Exp $";
...
*****************************************************************************/
double Vic::CalcSnowPackEnergyBalance(double Tsurf, ...)
{
  ...
  va_start(ap, Tsurf);
  Qnet = SnowPackEnergyBalance(this,Tsurf, ap);
  va_end(ap);
  
  return Qnet;
}

double Vic::ErrorSnowPackEnergyBalance(double Tsurf, ...)
{
...
double Vic::ErrorPrintSnowPackEnergyBalance(double TSurf, va_list ap)
{
