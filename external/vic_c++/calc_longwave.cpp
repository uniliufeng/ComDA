...
static char vcid[] = "$Id: calc_longwave.c,v 5.2 2004/05/06 22:29:38 tbohn Exp $";

void Vic::calc_longwave(double *longwave, 
		   double  tskc, 
		   double  air_temp, 
		   double  vp)
/***************************************************************************
...
void Vic::calc_netlongwave(double *longwave, 
		      double  tskc, 
		      double  air_temp, 
		      double  vp)
/****************************************************************************
