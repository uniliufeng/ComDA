...
static char vcid[] = "$Id: root_brent.c,v 5.3.2.3 2009/05/24 07:55:25 vicadmin Exp $";
...
*****************************************************************************/
double Vic::root_brent(double LowerBound, double UpperBound, char *ErrorString,
                double (*Function)(Vic* pvic,double Estimate, va_list ap), ...)
{
  ...
  fa = Function(this,a, ap);
  va_start(ap, Function);
  fb = Function(this,b, ap);
