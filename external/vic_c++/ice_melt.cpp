...
static char vcid[] = "$Id: ice_melt.c,v 5.9.2.7 2009/10/08 21:30:59 vicadmin Exp $";
...
*****************************************************************************/
double Vic::CalcIcePackEnergyBalance(double Tsurf, ...)
{
  ...
  va_start(ap, Tsurf);
  Qnet = IceEnergyBalance(this,Tsurf, ap);
  va_end(ap);
  
  return Qnet;
}

double Vic::ErrorIcePackEnergyBalance(double Tsurf, ...)
{
...
double Vic::ErrorPrintIcePackEnergyBalance(double TSurf, va_list ap)
{
