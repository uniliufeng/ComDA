...
double Vic::linear_interp(double x,double lx,double ux,double ly,double uy) {
  return((x-lx)/(ux-lx)*(uy-ly)+ly);
}

double Vic::exp_interp(double x,double lx,double ux,double ly,double uy) {
  return(uy+(ly-uy)*exp(-(x-lx)));
}

double Vic::modify_Ksat(double Temp) {
/**********************************************************************
