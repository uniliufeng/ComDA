...
static char vcid[] = "$Id: read_arcinfo_ascii.c,v 4.2 2005/08/25 21:04:19 vicadmin Exp $";

double Vic::read_arcinfo_value(char *filename,
			  double lat,
			  double lng) {
/**********************************************************************
...
int Vic::read_arcinfo_info(char    *filename,
		      double **lat,
		      double **lng,
		      int    **cellnum) {
/**********************************************************************
