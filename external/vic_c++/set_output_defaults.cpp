...
static char vcid[] = "$Id: set_output_defaults.c,v 5.2.2.3 2008/04/14 22:44:54 vicadmin Exp $";

out_data_file_struct* Vic::set_output_defaults(out_data_struct *out_data) {
/*************************************************************
