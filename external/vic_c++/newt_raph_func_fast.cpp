...
int Vic::newt_raph(void (ldas::Vic::*vecfunc)(double x[], double fvec[], int n, int init, ...), 
               double x[], int n)
{
...
void Vic::fdjac3(double x[], double fvec[], double a[], double b[], double c[],
            void (ldas::Vic::*vecfunc)(double x[], double fvec[], int n, int init, ...), 
            int n)
{
...
void Vic::tridiag(double a[], double b[], double c[], double r[], unsigned n)
{
