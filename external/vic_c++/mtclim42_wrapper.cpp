...
static char vcid[] = "$Id: mtclim42_wrapper.c,v 5.3 2004/05/06 22:29:41 tbohn Exp $";
...
/*			      FUNCTION PROTOTYPES                             */
/******************************************************************************/
void Vic::mtclim42_wrapper(int have_dewpt, int have_shortwave, double hour_offset,
...
void Vic::mtclim42_init(int have_dewpt, double elevation, double annual_prcp, 
...
void Vic::mtclim42_to_vic(int have_dewpt, int have_shortwave, double hour_offset, 
		     global_param_struct *vic_global, dmy_struct *dmy, 
		     double *tiny_radfract, control_struct *ctrl, 
