...
static char vcid[] = "$Id: CalcBlowingSnow.c,v 1.4.2.1 2007/04/18 20:18:58 vicadmin Exp $";
...
*****************************************************************************/
double Vic::CalcBlowingSnow( double Dt,
			double Tair,
			int LastSnow,
...
double Vic::qromb(double (*funcd)(double z,double es,  double Wind, double AirDens, double ZO,
...
void Vic::polint(double xa[], double ya[], int n, double x, double *y, double *dy)
{
  int i, m, ns;
...
double Vic::trapzd(double (*funcd)(double z,double es,  double Wind, double AirDens, double ZO,
                           double EactAir,double F, double hsalt, double phi_r,
                           double ushear, double Zrh), double es, double Wind, double AirDens, double ZO,
...
double Vic::rtnewt(double x1, double x2, double acc, double Ur, double Zr)
{
  int j;
...
void Vic::get_shear(double x, double *f, double *df, double Ur, double Zr) {
...
*****************************************************************************/
double Vic::sub_with_height(double z,
		       double es,
		       double Wind,
		       double AirDens,
		       double ZO,
...
double Vic::get_prob(double Tair, double Age, double SurfaceLiquidWater, double U10)
{
...
double Vic::get_thresh(double Tair, double SurfaceLiquidWater, double Zo_salt, int flag)
{
  double ut10;
  double utshear;
...
void Vic::shear_stress(double U10, double ZO,double *ushear, double *Zo_salt, double utshear)
{
...
double Vic::CalcSubFlux(double EactAir, double es, double Zrh, double AirDens, double utshear,
...
*****************************************************************************/
double Vic::transport_with_height(double z,
		       double es,
		       double Wind,
		       double AirDens,
		       double ZO,
