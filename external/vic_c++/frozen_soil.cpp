...
int Vic::finish_frozen_soil_calcs(energy_bal_struct *energy,
...
int  Vic::solve_T_profile(double *T,
		     double *T0,
		     char   *Tfbflag,
		     int    *Tfbcount,
		     double *Zsum,
...
int Vic::solve_T_profile_implicit(double *T,                           // update
			     double *T0,                    // keep
...
int Vic::calc_soil_thermal_fluxes(int     Nnodes,
			     double *T,
			     double *T0,
			     char   *Tfbflag,
			     int    *Tfbcount,
...
double Vic::error_solve_T_profile (double Tj, ...) {
...
double Vic::error_print_solve_T_profile(double T, va_list ap) {
...
void Vic::fda_heat_eqn(double T_2[], double res[], int n, int init, ...)
{
  /**********************************************************************
