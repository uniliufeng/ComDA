...
static char vcid[] = "$Id: initialize_lake.c,v 5.10.2.11 2009/10/08 21:30:59 vicadmin Exp $";

int Vic::initialize_lake (lake_var_struct   *lake, 
...
int Vic::get_sarea(lake_con_struct lake_con, double depth, double *sarea)
/******************************************************************************
...
int Vic::get_volume(lake_con_struct lake_con, double depth, double *volume)
/******************************************************************************
...
int Vic::get_depth(lake_con_struct lake_con, double volume, double *depth)
/******************************************************************************
...
int Vic::get_depth_from_sarea(lake_con_struct lake_con, double sarea, double *depth)
/******************************************************************************
...
int Vic::ice_depth(lake_con_struct lake_con, double volume, double ice_water_eq, double *hice)
/******************************************************************************
