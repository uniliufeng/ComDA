...
static char vcid[] = "$Id: calc_forcing_stats.c,v 5.2 2004/05/06 22:29:38 tbohn Exp $";

#if OUTPUT_FORCE_STATS

void Vic::calc_forcing_stats(int                Nrecs,
/* 			int                cell, */
/* 			double             lat, */
/* 			double             lng, */
...
double Vic::get_mean(double *values, int N, double NoData) {
...
double Vic::get_stdev(double *values, int N, double mean, double NoData) {
...
double Vic::get_sum(double *values, int N, double NoData) {
...
double Vic::get_min(double *values, int N, double NoData) {
...
double Vic::get_max(double *values, int N, double NoData) {
