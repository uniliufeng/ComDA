...
using namespace ldas::vic;

static char vcid[] = "$Id: mtclim42_vic.c,v 5.5.2.1 2007/05/04 21:30:46 vicadmin Exp $";
...
int Vic::data_alloc(const control_struct *ctrl, data_struct *data)
{
  int ok=1;
  int ndays;
...
int Vic::calc_tair(const control_struct *ctrl, const parameter_struct *p, 
	      data_struct *data)
{
  int ok=1;
  int i,ndays;
...
int Vic::calc_prcp(const control_struct *ctrl, const parameter_struct *p, 
	      data_struct *data)
{
  int ok=1;
  int i,ndays;
...
/* start vic_change */
int Vic::calc_srad_humidity(const control_struct *ctrl, const parameter_struct *p, 
...
/* start vic_change */
int Vic::calc_srad_humidity_iterative(const control_struct *ctrl,
...
int Vic::data_free(const control_struct *ctrl, data_struct *data)
{
  int ok=1;
...
double Vic::calc_pet(double rad, double ta, double pa, double dayl)
{
...
double Vic::atm_pres(double elev)
{
...
int Vic::pulled_boxcar(double *input,double *output,int n,int w,int w_flag)
{
  int ok=1;
  int tail,i,j;
  double *wt;
