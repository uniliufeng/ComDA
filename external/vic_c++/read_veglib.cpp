...
static char vcid[] = "$Id: read_veglib.c,v 4.2.2.3 2009/10/01 21:12:16 vicadmin Exp $";

veg_lib_struct* Vic::read_veglib(FILE *veglib, int *Ntype)
/**********************************************************************
...
**********************************************************************/
void Vic::free_veglib(veg_lib_struct **veg_lib) {
