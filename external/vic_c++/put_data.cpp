...
static char vcid[] = "$Id: put_data.c,v 5.14.2.26 2009/10/13 19:47:21 vicadmin Exp $";

int  Vic::put_data(dist_prcp_struct  *prcp,
...
void Vic::collect_wb_terms(cell_data_struct  cell,
                      veg_var_struct    veg_var,
                      snow_data_struct  snow,
                      lake_var_struct   lake_var,
                      double            mu,
...
void Vic::collect_eb_terms(energy_bal_struct energy,
                      snow_data_struct  snow,
