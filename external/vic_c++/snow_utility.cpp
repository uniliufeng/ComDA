...
double Vic::snow_density(snow_data_struct *snow, double new_snow, double sswq, double Tgrnd, double Tair, double dt)
{
/**********************************************************************
...
double Vic::new_snow_density(double air_temp) {
/**********************************************************************
...
double Vic::snow_albedo(double new_snow,
                   double swq,
                   double depth,
                   double albedo,
                   double cold_content,
