...
/* use the Hermite polynomials, to find the interpolation function value at 
   xbar */
double Vic::hermint(double xbar, int n, double *x, double *yc1, double *yc2, 
...
void Vic::set_max_min_hour(double *hourlyrad, 
		      int ndays, 
		      int *tmaxhour,
		      int *tminhour)
{
