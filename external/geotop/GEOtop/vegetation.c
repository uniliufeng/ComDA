...
/******************************************************************************************************************************************/
/******************************************************************************************************************************************/
/* Calculate Canopy Temperature Tv
 *
 * Output:Tv0,Ts,Qs,H,E,dH_dT,dE_dT
 *
 * Tv0:	canopy temperature at the beginning of the time step
 * e:	emissivity of the surface
 *LW:	=LWin incoming longwave
 *Ts:	temperature of canopy air
 *Tg0:	= egy->T0->co[1] The surface Temp under canopy at the beginning
 *z0:	=z0v	roughness length for veg after considering snow depth
 *d0:	=d0v	displacement height for veg after considering snow depth
...
void Tcanopy(long r, long c, double Tv0, double Tg, double Qg, double dQgdT, double Tg0, double Qg0, double Ta, double Qa, 
	...
	/*T00 Initial Veg Temp at the beggining
	 * */
...
/* e: 	emissivity of the surface
 *LW:  	=LWin incoming longwave
 *LWv:	The longwave radiation absorbed by canopy
 *Ts:   temperature of canopy air
 *rm:	resistance for momentum transfer
 *rh:	resistance for heat transfer
 *rv:	resistance for vapor transfer
 *
 */
void canopy_fluxes(long r, long c, double Tv, double Tg, double Ta, double Qgsat, double Qa, double zmu, double zmT, double z0, 
	...
	//LONGWAVE Calculate the LWv,LWg for given Tv,Tg,LW
...
/******************************************************************************************************************************************/
/* LONGWAVE Calculate the LWv,LWg for given Tv,Tg,LW
 * Output: Lv,Lg,dLv_dTv,Lup_above
 * Tg:	surface skin temperature used to compute the surface energy fluxes,Tg = egy->Temp->co[1];
 * Lin:	 =LW:  	=LWin incoming longwave
 * eg: 	emissivity of the surface,First Layer under canopy
 * L:	LSAI
 * Lv:	LWv = longwave absorbed by vegetation
 * Lg:	LWg = Longwave absorbed by surface (ground?)
 * Lup_above:	 LWup_above_v
 */
void longwave_vegetation(double Lin, double eg, double Tg, double Tv, double LSAI, double *Lv, double *Lg, double *dLv_dTv, double *Lup_above){
...
/******************************************************************************************************************************************/
/******************************************************************************************************************************************/
/*Calculate rb,rh under the canopy
 *
 *
 *
 * */
