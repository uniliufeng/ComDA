...
/**-----------------------------------------------------------------------*/
/** to determine whether the following content is comment. If it is comment,
 * 	the function return none zero value,else return zero
 */
...
/**-----------------------------------------------------------------------*/
/** Read a comment block from the current pos in the input file
 *
 */
...
/** read comment blocks from the input file*/
...
/**read the string array from the file
 *
 */
curl=fgetc(inputfile);
