...
C
     ...
     >  SUNHOR,TMPDAY,WINDAY,HUMDAY,PRECIP,
     >  SNODEN,SOITMP,VLCDAY,SOILXT)
C
C***********************************************************************
...
C
     ...
     >     RLEAF0(8),RROOT0(8),ZC(11)
      REAL ZSP(150),DZSP(150),RHOSP(150)
...
C
     ...
     >     PLTHGT(8),PLTWGT(8),PLTLAI(8),ROOTDP(8),QVC(10)
      ...
      REAL TSP(150),TSPDT(150),DLW(150),DLWDT(150),USP(150),SSP(150),
     >     QVSP(150),TQVSP(150),WLAG(11)
      REAL BTSP(150),BDLW(150)
...
C
      ...
      INTEGER IBICES(50),ICES(50),ICESDT(50),ICESP(150),ICESPT(150)
C
      SAVE NPRINT,MAXSTP,MINSTP
      DATA NPRINT/ 0/ MAXSTP/ 0/ MINSTP/ 0/

	REAL SUNHOR,TMPDAY,WINDAY,HUMDAY,PRECIP,SNODEN,SOITMP,VLCDAY
...
C
C     -- Check for file created by ModShell (user interface).  If it exists, suppress
...
C
  900 IF (IOS.EQ.0) THEN           
         CLOSE (99)
         OPEN (UNIT=10,FILE='SHAWMOD.FOF',STATUS='OLD')           !trial.inp 10
        ELSE         
         WRITE (6,105)
         READ (5,100) IFILE                 !IFILE=trial.inp
         WRITE (6,*)
...
C     MTSTEP=0:  hourly weather data;
C     INPH2O=0:  soil water in term of volumetric water content
C     MWATRXT=0: no sink term is specified
C
...
C
     ...
     >     SALTDT(10,50)
C	REAL SAND(50), SILT(50), CLAY(50), RHOB(50);
      REAL GMCDT(10)
      REAL TSPDT(150),DLWDT(150)
      REAL WCANDT(10)
      REAL PLTHGT(8),PLTWGT(8),PLTLAI(8),ROOTDP(8)
      INTEGER YRSTAR,HRSTAR,YREND
      INTEGER ICESDT(50),ICESPT(150),LEVEL(6),LVLOUT(15)
...
C        CHECK FOR EXCEPTIONS -> END OF YEAR OR CALLING HOUR 0, HOUR 24
	 ...
	 IF (JD.EQ.1 .AND. JH.EQ.0 .AND. JYR .EQ. (YEAR+1)) GO TO 25
...
C     AND SUNSET
      DECLIN = 0.4102*SIN(2.0*PI*(JULIAN-80.0)/365.)
...
C***********************************************************************
      COMMON /CLAYRS/ DRYCAN(8,10),CANLAI(8,10),TOTLAI(8),IEVAP(8),
     >                RLEAF(8,10),RROOT(8,50),ROOTDN(8,50),TOTROT(8)
      REAL PLTHGT(8),PLTWGT(8),PLTLAI(8),ZSP(150),RLEAF0(8),ZC(11),
...
C
      REAL SWCAN(9,10),SWSNOW(150),SWRES(10),CANALB(8),
     >  ZSP(150),DZSP(150),RHOSP(150),ZR(10),RHOR(10)
...
C***********************************************************************
     ...
     >                TKL,TKI,TKA,TKR,TKSA,TKSI,TKCL,TKOM
      ...
      REAL LF,LS,LV
C
      REAL SWSNOW(150),RHOSP(150),DZSP(150)
C
...
C***********************************************************************
     ...
     >     VLC(50),VLCDT(50),VIC(50),VICDT(50),SALT(10,50),SALTDT(10,50)
      ...
      REAL TC(11),TCDT(11),VAPC(11),VAPCDT(11),WCAN(10),WCANDT(10),
     >     PCAN(8),PCANDT(8)
      REAL TSP(150),TSPDT(150),DLW(150),DLWDT(150)
      INTEGER ICES(50),ICESDT(50),ICESP(150),ICESPT(150)
C
C     SOIL PROPERTIES
      DO 15 I=1,NS
         TS(I)=TSDT(I)
...
C***********************************************************************        
      ...
      COMMON /LWRCOF/ STEFAN,EMATM1,EMATM2,EMITC,EMITR,EMITSP,EMITS             
C
      REAL TC(11),TCDT(11),TSP(150),TSPDT(150),TR(10),TRDT(10),                 
...
C***********************************************************************
      COMMON /TIMEWT/ WT,WDT,DT
      COMMON /LWRCOF/ STEFAN,EMATM1,EMATM2,EMITC,EMITR,EMITSP,EMITS
      REAL LWRTOP,LWRBOT,IN,TSP(150),TSPDT(150)
C
...
C***********************************************************************
     ...
     >                A2(150),B2(150),C2(150),D2(150)
      ...
      COMMON /RADCAN/ TDIRCC(10),TDIFFC(10),DIRKL(9,10),DIFKL(9,10)
      COMMON /RADRES/ TDIREC(10),TDIFFU(10)
      REAL TC(11),TSP(150),TR(10),TS(50)
      INTEGER ICESPT(150)
C
      N = 1
      MATERL=2
...
C
C***********************************************************************
      REAL UC(10),SC(10),USP(150),SSP(150),UR(10),SR(10),US(50),
     >     SS(50),SINK(10,50),SWCAN(9,10),SWSNOW(150),SWRES(10),SWSOIL,
...
C***********************************************************************
     ...
     >                TKL,TKI,TKA,TKR,TKSA,TKSI,TKCL,TKOM
      COMMON /MATRIX/ A1(150),B1(150),C1(150),D1(150),
     >                A2(150),B2(150),C2(150),D2(150)
      REAL TSP(150),TSPDT(150),DLW(150),DLWDT(150),RHOSP(150),
     >     ZSP(150),DZSP(150),QVSP(150),SSP(150)
      REAL QVSPT(150),QVSPDT(150),TK(150),CON(150),CONV(150),SLOPE(150),
     >     CSP(150),CSPT(150),CSPDT(150)
      INTEGER ICESPT(150)
      REAL LF,LS,LV
      SAVE QVSPT,CON,CSPT
C
...
C***********************************************************************
     ...
     >                TKL,TKI,TKA,TKR,TKSA,TKSI,TKCL,TKOM
      COMMON /SPPROP/ G1,G2,G3,EXTSP,TKSPA,TKSPB,TKSPEX,VDIFSP,VAPSPX
      REAL QVSP(150),TSP(150),ZSP(150),VAPSNO(150),
     >     VAPICE(150),SLOPE(150),CONV(150)
      REAL LF,LS,LV
C
...
C***********************************************************************
     ...
     >                CM,COM,CA,CV,CR,VONKRM,VDIFF,PRESUR,P0,
     >                TKL,TKI,TKA,TKR,TKSA,TKSI,TKCL,TKOM
      REAL CSP(150),TSP(150),RHOSP(150)
      REAL LF,LS,LV
C
      DO 10 I=1,NSP
...
C
     ...
     >     RHOR(10),SR(10),UR(10),QVR(10),RHOSP(150)
...
C***********************************************************************
     ...
     >                TKL,TKI,TKA,TKR,TKSA,TKSI,TKCL,TKOM
      ...
      REAL LF,LS,LV
C
      REAL TR(10),TRDT(10),GMC(10),GMCDT(10),RHOR(10),RHOSP(150)
      REAL CONVEC(10),TKRES(10),TKSP(150)
      DATA RESDEN/ 170./ 
C
      IF (NSP .GT. 0) THEN
...
C***********************************************************************
     ...
     >                A2(150),B2(150),C2(150),D2(150)
      ...
      REAL LF,LS,LV
C
      REAL ZSP(150),QVSP(150),TSPDT(150),TSDT(50)
C
...
C
      REAL ZR(10),TR(10),TRDT(10),VAPR(10),VAPRDT(10),GMC(10),GMCDT(10),
     >     RHOR(10),QVR(10),RHOSP(150),CONV(10),VAPCON(10),CONVEC(10),
     >     TKRES(10)
C
C**** DETERMINE THE HEAT TRANSFER COEFFICIENT FOR EACH NODE
      CALL RESTK (NR,NSP,TKRES,CONVEC,TR,TRDT,GMC,GMCDT,RHOR,RHOSP)
...
C
     ...
     >     SWSNOW(150),SWRES(10)
C
      REAL QVC(10),QVR(10),QVSP(150),QSL(50),QSV(50),TRNSP(9),
     >     XTRACT(50),ROOTXT(50),TOTFLO(50),TQVSP(150),TRANSP(8)
      REAL LF,LS,LV
C
      SAVE TRANSP
C
...
C***********************************************************************
     ...
     >                TKL,TKI,TKA,TKR,TKSA,TKSI,TKCL,TKOM
      REAL LF,LS,LV
C
      REAL ZC(11),WCANDT(10),PCANDT(8),ZSP(150),DZSP(150),TSPDT(150),
     >    DLW(150),DLWDT(150),RHOSP(150),TQVSP(150),WLAG(11),
     >    ZR(10),TRDT(10),GMCDT(10),RHOR(10),ZS(50),TSDT(50),VLCDT(50),
     >    VICDT(50),MATDT(50),TOTFLO(50),SALTDT(10,50),CONCDT(10,50)
      REAL MELT
      INTEGER LANGLE(8),ITYPE(8),ICESPT(150),ICESDT(50)
C
...
C***********************************************************************
     ...
     >                THICK,CTHICK
      REAL LF,LS,LV
C
      REAL ZSP(150),DZSP(150),RHOSP(150),TSPDT(150),DLW(150),DLWDT(150),
     >  TQVSP(150)
      REAL ZC(11),PCANDT(8)
...
C***********************************************************************
     ...
     >                THICK,CTHICK
      REAL LF,LS,LV
C
      REAL RHOSP(150),DZSP(150),ZSP(150),TSPDT(150),DLW(150),DLWDT(150),
     >  TQVSP(150),WLAG(11)
      INTEGER ICESPT(150)
C
      SCOUT = 0.0
...
C***********************************************************************
     ...
     >                TKL,TKI,TKA,TKR,TKSA,TKSI,TKCL,TKOM
      COMMON /METASP/ CMET1,CMET2,CMET3,CMET4,CMET5,SNOMAX
      REAL TSPDT(150),RHOSP(150),DZSP(150),DLWDT(150)
      REAL LF,LS,LV
C
...
C***********************************************************************
     ...
     >                THICK,CTHICK
      REAL LF,LS,LV
C
      REAL DZSP(150),RHOSP(150),TSPDT(150),DLWDT(150),WLAG(11)
      INTEGER ICESPT(150)
      SAVE IFIRST,NLAG
      DATA IFIRST/0/
C
...
C
     ...
     >     VAPCDT(11),RHOSP(150),DZSP(150),DLWDT(150),WLAG(11),ZR(10),
...
C***********************************************************************
     ...
     >                SAND(50),SILT(50),CLAY(50),OM(50)
      ...
      REAL LF,LS,LV
C
      REAL ZC(11),TCDT(11),VAPCDT(11),WCANDT(10),ROOTXT(50),RHOSP(150),
     >     ZSP(150),TSPDT(150),DLWDT(150),ZR(10),TRDT(10),VAPRDT(10),
...
C***********************************************************************
C
      REAL ZSP(150),ZS(50),VLCDT(50),VICDT(50)
